...
import { TreeViewAlt } from "carbon-icons-svelte";
...
export class MultiAction implements Action {
    static readonly identifier: string = "Multi";
    static readonly description: string = "Tap though Multiple Actions";
    static readonly icon: SvelteComponent = TreeViewAlt;
